...
Super simple. Select the update, select who gets it, schedule it, and watch it go. All in, it took about 10 mins for the update to hit the workstation and start installing.
